...
import time
import numpy as np
from state_diff.real_world.multi_realsense import MultiRealsense
from state_diff.real_world.video_recorder import VideoRecorder

def test():
    config = json.load(open('/home/cchi/dev/state_diff/state_diff/real_world/realsense_config/415_high_accuracy_mode.json', 'r'))
    ...
    from state_diff.common.cv2_util import get_image_transform
