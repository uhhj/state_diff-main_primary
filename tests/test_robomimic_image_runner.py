...
from state_diff.env_runner.robomimic_image_runner import RobomimicImageRunner

def test():
    import os
    from omegaconf import OmegaConf
    cfg_path = os.path.expanduser('~/dev/state_diff/state_diff/config/task/lift_image.yaml')
